package org.healthonnet.spellcheck.levenstein;
 ...
 * and "candid," but 0.8 between "candi" and "candy."  This causes "candid" to be ranked higher
 * in the suggestion results, regardless of its frequency.  This class gives the same score, 0.8, for both.
 */
public final class NormalizedLevensteinDistance implements StringDistance {

    /**
     * Optimized to run a bit faster than the static getDistance().
     * In one benchmark times were 5.3sec using ctr vs 8.5sec w/ static method, thus 37% faster.
     */
    public NormalizedLevensteinDistance () {
    }
    ...
    public float getDistance (String target, String other) {
      ...
      int _d[]; //placeholder to assist in swapping p and d
        ...
        return 1.0f - ((float)Math.min(p[n], sa.length) / sa.length);
    }
